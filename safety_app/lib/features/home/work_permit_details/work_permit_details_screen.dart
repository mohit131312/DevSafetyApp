...
class WorkPermitDetailsScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        AppTextWidget(
                                            text: 'SubActivity of Work Permit',
                                            fontSize: AppTextSize.textSizeSmall,
                                            fontWeight: FontWeight.w400,
                                            color: AppColors.searchfeild),
                                        SizedBox(
            ...
            Obx(
              () => workPermitAllController.isprecautionworkpermitExpanded.value
                  ? Container(
                      padding: EdgeInsets.symmetric(
                        horizontal: SizeConfig.widthMultiplier * 4,
                        vertical: SizeConfig.heightMultiplier * 2,
  ...
  Widget buildCategoryWidgetContainer() {
    final categoryMap = workPermitAllController.categoryListHomeList;
