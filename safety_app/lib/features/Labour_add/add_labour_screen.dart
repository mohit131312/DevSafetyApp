                ...
                Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(
                        () => AppTextFormfeild(
                          controller: addLabourController.labournameController,
                          hintText: 'Full Name',
                              ...
                              child: ChoiceChip(
                                ...
                                selected:
                                    addLabourController.selectedGender.value ==
                                        index,
                                onSelected: addLabourController.userFound.value
                                    ? null
                                    : (selected) {
                                    ...
                                    children: [
                                      ...
                                      Obx(
                                        () => AppSearchDropdown(
                                          ...
                                          onChanged: (value) {
                                            addLabourController.selectedDistrict
                                                .value = value ?? '';
                                ...
                                children: [
                                  addLabourController.userFound.value
                                      ? Checkbox(
                                          ...
                                          onChanged: (value) {
                                            addLabourController.isSameAsCurrent
                                                .value = value ?? false;
                                          },
                                        )
                                      : Obx(() => Checkbox(
