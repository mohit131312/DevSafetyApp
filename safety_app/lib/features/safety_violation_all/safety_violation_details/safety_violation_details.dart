            ...
            child:
              ...
              Column(
                children: [
                  ...
                  Obx(
                    () => safetyViolationDetailsController.violationImageCount <
                            1
                        ? GestureDetector(
                            onTap: () {
                  ...
                  Obx(
                    () => AppSearchDropdown(
                      ...
                      items: safetyViolationDetailsController.violationTypeList
                          .map(
                      ...
                      onChanged: (value) {
                        safetyViolationDetailsController.selectViolation.value =
                            value ?? '';
                        var selectedType = safetyViolationDetailsController
                            .violationTypeList
                    ...
                    () => AppSearchDropdown(
                      ...
                      onChanged: (value) {
                        safetyViolationDetailsController.selectCategory.value =
                            value ?? '';
                        var selectedCategory = safetyViolationDetailsController
                            .categoryList
                            .firstWhereOrNull(
                                (category) => category.safetyDetails == value);

                        if (selectedCategory != null) {
                          safetyViolationDetailsController
                              .selectCategoryId.value = selectedCategory.id;
                  ...
                  AppTextFormfeild(
                    ...
                    onFieldSubmitted: (_) {
                      safetyViolationDetailsController.loactionofBreachFocusNode
                          .unfocus();
                    },
                    keyboardType: TextInputType.name,
                    textInputAction: TextInputAction.next,
                  ...
                  Obx(
                    () => AppSearchDropdown(
                      items: safetyViolationDetailsController.riskLevelList
                          .map(
                      ...
                      onChanged: (value) {
                        safetyViolationDetailsController.selectRisklevel.value =
                            value ?? '';
                        var selectedrisk = safetyViolationDetailsController
                            .riskLevelList
                            .firstWhereOrNull(
                                (risk) => risk.safetyDetails == value);
                  ...
                  AppTextFormfeild(
                    ...
                    onFieldSubmitted: (_) {
                      safetyViolationDetailsController.turnArounttimeFocusNode
                          .unfocus();
                    },
                  ...
                  Obx(
                    () => AppSearchDropdown(
                      items: safetyViolationDetailsController.souceofObsList
                          .map(
                  ...
                  Obx(
                    () {
                      final selectedList =
                          selectInvolvedPersonController.addInvolveStaffPerson;
                      ...
                      return selectInvolvedPersonController
                          ...
                          ? Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(8)),
                              height: selectInvolvedPersonController
                                          .selectedContractorIdsFinal.length >
                                      1
                                  ? SizeConfig.heightMultiplier * 24
                                  : SizeConfig.heightMultiplier * 11,
                              child: Scrollbar(
                  ...
                  Obx(
                    () {
                      final selectedList = selectSafetyInformedPeopleController
                      ...
                      return selectSafetyInformedPeopleController
                          ...
                          ? Container(
                              ...
                              height: selectSafetyInformedPeopleController
                                          .selectedAssigneeIdsFinal.length >
                                      1
                                  ? SizeConfig.heightMultiplier * 24
                                  : SizeConfig.heightMultiplier * 11,
                              child: Scrollbar(
