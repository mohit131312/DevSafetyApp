            ...
            child: Form(
              ...
              child: Column(
                  ...
                  children: [
                        ...
                        onChanged: (value) async {
                          ...
                          if (value != null) {
                            var selectedActivityObj =
                                inductionTrainingController.activityList
                                    .firstWhereOrNull((activity) =>
                                        activity.activityName == value);

                            if (selectedActivityObj != null) {
                              serviceDetailsController.selectedActivityId
                                  .value = selectedActivityObj.id;
                        ...
                        onChanged: (value) {
                          ...
                          if (value != null) {
                            var selectedSubActivityObj =
                                serviceDetailsController.subActivityMatchedList
                                    .firstWhereOrNull((subact) =>
                                        subact.subActivityName == value);
                    ...
                    Obx(() =>
                        serviceDetailsController.subActivityError.isNotEmpty
                            ? Padding(
                                padding: EdgeInsets.only(top: 4, left: 13),
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                      ...
                      onPressed: addContractorController.userFound.value
                          ...
                          : () {
                              ...
                              if (serviceDetailsController
                                ...
                                serviceDetailsController.subActivityError
                                    .value = "Please select a SubActivity ";
                              }
                            },
                      child: Row(
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          AppTextWidget(
                                                                              text: serviceDetailsController.selectActivityList[index],
                                                                              fontSize: AppTextSize.textSizeSmalle,
                                                                              fontWeight: FontWeight.w400,
                                                                              color: AppColors.primaryText),
                                                                          SizedBox(
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          AppTextWidget(
                                                                              text: serviceDetailsController.selectSubActivityList[index],
                                                                              fontSize: AppTextSize.textSizeSmalle,
                                                                              fontWeight: FontWeight.w400,
                                                                              color: AppColors.primaryText),
                                                                        ],
