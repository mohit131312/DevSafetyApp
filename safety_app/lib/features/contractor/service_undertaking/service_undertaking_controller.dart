...
class ServiceUndertakingController extends GetxController {
  ...
  void toggleContactorCheckboxSign() {
  ...
  void toggleContactorCheckboxUndertaking(int index) {
  ...
  void toggleContactorSelectAllUndertaking() {
  ...
  Future<void> saveContactorSignature() async {
    try {
  ...
  void clearContactorAllCheckboxes() {
    for (var item in filteredDetailsUndertaking) {
