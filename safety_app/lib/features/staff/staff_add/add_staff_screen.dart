              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                        ...
                        child: Container(
                          ...
                          child: Obx(
                            () => DropdownButton<String>(
                              ...
                              value:
                                  addStaffController.searchType.value.isNotEmpty
                    ...
                    GestureDetector(
                      onTap: () async {
                        String value = addStaffController.searchController.text;
                ...
                Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(
                        () => Row(
                          ...
                          children: List.generate(
                              addStaffController.gendersStaff.length, (index) {
                            return Padding(
                              padding: EdgeInsets.symmetric(
                              ...
                              child: ChoiceChip(
                                label: Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 5),
                                    Text(addStaffController.gendersStaff[index]
                                            ['label'] ??
                                        ''),
                                  ],
                                ),
                                ...
                                onSelected: addStaffController.userFound.value
                                    ? null
                                    : (selected) {
                                        addStaffController.selectGender(index);
                                      },
                                selectedColor: Colors.white, // Adjust as needed
                                backgroundColor: Colors.white,
                                side: BorderSide(
                                    ...
                                    children: [
                                        ...
                                        () => AppSearchDropdown(
                                          ...
                                          onChanged: (value) async {
                                            ...
                                            if (value != null) {
                                              ...
                                              addStaffController.selectedStateId
                                      ...
                                      Obx(
                                        () => AppSearchDropdown(
                                          ...
                                          onChanged: (value) {
                                            addStaffController.selectedDistrict
                                                .value = value ?? '';
                      ...
                      Obx(
                        () => AppTextFormfeild(
                          controller: addStaffController.econtactnameController,
                          hintText: 'Emergency contact name',
                          focusNode: addStaffController.econtactnameFocusNode,
                          onFieldSubmitted: (_) {
                            addStaffController.econtactnameFocusNode.unfocus();
                          },
                          keyboardType: TextInputType.name,
                          textInputAction: TextInputAction.next,
                          enabled: !addStaffController.userFound
                      ...
                      Obx(
                        () => AppTextFormfeild(
                          ...
                          focusNode: addStaffController.econtactnumberFocusNode,
                          onFieldSubmitted: (_) {
