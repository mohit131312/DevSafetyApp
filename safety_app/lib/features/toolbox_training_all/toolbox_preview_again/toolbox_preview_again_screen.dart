...
import 'package:flutter_app/features/toolbox_training_all/toolbox_submit/toolbox_submit_again_screen.dart';
...
class ToolboxPreviewAgainScreen extends StatelessWidget {
  ToolboxPreviewAgainScreen({super.key});
          ...
          actions: [
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.to(ToolboxSubmitAgainScreen());
                  },
                  child: Container(
                    alignment: Alignment.center,
                    height: 40,
