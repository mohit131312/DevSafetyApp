...
class StaffPrecautionController extends GetxController {
  ...
  void searchStaffDataEquipment(String query) {
  ...
  void searchDataStaffInstruction(String query) {
  ...
  void toggleStaffSelectAllInstruction() {
  ...
  void toggleStaffSelectionInstruction(int id) {
  ...
  bool validateStaffInstructionSelection() {
