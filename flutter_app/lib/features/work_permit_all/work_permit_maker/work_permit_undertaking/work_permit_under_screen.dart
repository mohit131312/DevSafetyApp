      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child:
              ...
              children: [
                ...
                Obx(
                  () => SizedBox(
                    ...
                    child: Checkbox(
                      value:
                          workPermitUnderController.isCheckedUndertaking.value,
                      ...
                      onChanged: (bool? value) {
                        workPermitUnderController.toggleSelectAllUndertaking();
                      },
                    ),
                  ),
                ),
            ...
            Obx(() => workPermitUnderController.signatureError.value.isNotEmpty
                ? Padding(
                    padding: const EdgeInsets.only(top: 4, left: 12),
                    child: Text(
